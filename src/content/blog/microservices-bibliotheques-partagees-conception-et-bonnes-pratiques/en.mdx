...
This means that if you don't do it well, it has the potential to negate one of the greatest benefits granted by microservices architecture! *The result is a strange mix of parts, like Frankenstein's monster.*
