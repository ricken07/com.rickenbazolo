...
```
1. Requête utilisateur (description du projet)
         ↓
2. Sélection des agents spécialisés
         ↓
3. Exécution parallèle (Virtual Threads)
   ┌─────────┬──────────────┬──────────────┐
...
4. Agrégation des résultats
         ↓
5. Évaluation qualité (Clarté, Complétude, Pertinence)
         ↓
6. Réponse finale avec feedback
```
