...
In the first part of this series, we set out to understand how the behavior of a system built on LLM capabilities is formed.

We started by <a href="/en/blog/figer-comportement-systeme-llm" target="_blank" rel="noopener noreferrer">establishing a behavioral reference</a>, then <a href="/en/blog/observer-avant-doptimiser" target="_blank" rel="noopener noreferrer">made execution observable</a>, <a href="/en/blog/la-trajectoire-de-decision" target="_blank" rel="noopener noreferrer">reconstructed the decision trajectory</a>, and <a href="/en/blog/les-surfaces-comportementales" target="_blank" rel="noopener noreferrer">identified the surfaces on which behavior can vary, drift, or regress</a>.
