...
Dans <a href="/fr/blog/les-surfaces-comportementales" target="_blank" rel="noopener noreferrer">la première partie de cette série</a>, nous avons cherché à comprendre comment se construit le comportement d'un système intégrant les capacités des LLM.

Nous avons commencé par établir une référence comportementale, puis rendu l'exécution observable, reconstitué la trajectoire de décision et identifié les surfaces sur lesquelles le comportement peut varier, dériver ou régresser.
